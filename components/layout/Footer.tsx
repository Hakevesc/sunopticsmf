        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
              ...
              {socialLinks.map((social) => (
                <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full border border-white/15 
                             flex items-center justify-center text-[#06ACE4]/70
                             hover:bg-[#06ACE4] hover:border-[#06ACE4] hover:text-white
              ...
              {quickLinks.map((link) => (
                <li key={link}>
                  <Link href={`/${link.toLowerCase()}`}
                    className="text-sm text-white/50 hover:text-[#06ACE4]
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/50">
              <a href="tel:+251902642222" className="block hover:text-[#06ACE4]/80 transition-colors duration-200">
                0902 642 222
              </a>
              <a href="tel:+251902642223" className="block hover:text-[#06ACE4]/80 transition-colors duration-200">
                0902 642 223
              </a>
              <a href="mailto:sunopticsmeskelflower@gmail.com" className="block hover:text-[#06ACE4]/80 transition-colors duration-200">
      ...
      <div className="border-t border-white/5">
        <div className="max-w-content mx-auto px-6 lg:px-8 py-6 
          ...
          <div className="flex gap-6">
            <Link href="/privacy" className="text-xs text-white/25 hover:text-[#06ACE4]/50
                                            transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-xs text-white/25 hover:text-[#06ACE4]/50
